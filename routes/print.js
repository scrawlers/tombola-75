...
//Box A
	...
	doc.text(content[0].box[2],134,122,{width:35,align:'center'});
	...
	doc.fontSize(12);
	doc.text(content[0].series,152,218);
//Box B
	doc.fontSize(32);
	...
	doc.fontSize(12);
	doc.text(content[1].series,307,218);
//Box C
	doc.fontSize(32);
	...
	doc.text(content[2].box[5],432,122,{width:35,align:'center'});
	doc.text(content[2].box[6],477,84,{width:35,align:'center'});
	doc.text(content[2].box[7],525,84,{width:35,align:'center'});
...
//Box D
	...
	doc.text(content[3].box[6],101,290,{width:35,align:'center'});
	doc.text(content[3].box[7],145,290,{width:35,align:'center'});
	doc.text(content[3].box[8],192,290,{width:35,align:'center'});
	...
	doc.text(content[3].box[14],238,385,{width:35,align:'center'});

	doc.fontSize(12);
	doc.text(content[3].series,142,426);
//Box E
	doc.fontSize(32);

	doc.text(content[4].box[0],297,236,{width:35,align:'center'});
	doc.text(content[4].box[1],342,236,{width:35,align:'center'});
	doc.text(content[4].box[2],387,273,{width:35,align:'center'});
	doc.text(content[4].box[3],432,273,{width:35,align:'center'});
	...
	doc.fontSize(12);
	doc.text(content[4].series,430,426);
//Box F
	doc.fontSize(32);
...
//	doc.font('Courier-Bold');
	...
	doc.text(content[5].box[4],128+6,177+467,{width:35,align:'center'});
	doc.text(content[5].box[5],173+8,177+467,{width:35,align:'center'});
	
	doc.fontSize(12);
	doc.text(content[5].series,152,218+467);
//Box B
	doc.fontSize(32);
//Box B
	doc.text(content[6].box[0],228+10,70+467,{width:35,align:'center'});
	...
	doc.text(content[6].box[4],272+12,123+467,{width:35,align:'center'});
	...
	doc.text(content[6].box[8],316+14,137+467,{width:35,align:'center'});
...
//Box C
	...
	doc.text(content[7].box[4],371+19,86+467,{width:35,align:'center'});
...
//Box D
	...
	doc.text(content[8].box[5],50+4,289+467,{width:35,align:'center'});
	doc.text(content[8].box[6],95+4,289+467,{width:35,align:'center'});
	doc.text(content[8].box[7],141+5,289+467,{width:35,align:'center'});
	doc.text(content[8].box[8],184+9,289+467,{width:35,align:'center'});
	doc.text(content[8].box[9],227+12,289+467+38,{width:35,align:'center'});

	doc.text(content[8].box[10],50+4,341+467,{width:35,align:'center'});
	doc.text(content[8].box[11],95+4,380+467,{width:35,align:'center'});
	doc.text(content[8].box[12],141+4,380+467,{width:35,align:'center'});
	doc.text(content[8].box[13],184+7,341+467,{width:35,align:'center'});
	doc.text(content[8].box[14],227+11,341+467,{width:35,align:'center'});

	doc.fontSize(12);
	doc.text(content[8].series,134,424+467);
//Box E
	doc.fontSize(32);
	...
	doc.text(content[9].box[7],326+15,327+429,{width:35,align:'center'});
	doc.text(content[9].box[8],372+16,289+505,{width:35,align:'center'});
	...
	doc.text(content[9].box[11],503+23,327+428,{width:35,align:'center'});
	
	doc.text(content[9].box[12],283+13,340+467,{width:35,align:'center'});
	doc.text(content[9].box[13],326+15,378+430,{width:35,align:'center'});
	...
	doc.text(content[9].box[16],460+19,378+430,{width:35,align:'center'});
	doc.text(content[9].box[17],503+22,340+467,{width:35,align:'center'});
	doc.fontSize(12);
	doc.text(content[9].series,430,424+467);
//Box F
	doc.fontSize(32);
